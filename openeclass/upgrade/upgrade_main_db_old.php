...
//  *************************************
	...
	if (!mysql_field_exists($mysqlMainDb,'cours_user','reg_date')) {
		...
		$min_reg_date_res = mysqli_fetch_row(db_query("SELECT MIN(reg_date) 
        ...
        if (!mysql_field_exists($mysqlMainDb,'cours','faculteid')) {
                ...
                db_query("UPDATE cours,faculte SET cours.faculteid = faculte.id
        ...
        if (!mysql_field_exists($mysqlMainDb,'cours_faculte','facid')) {
                ...
                db_query("UPDATE cours_faculte,faculte SET cours_faculte.facid = faculte.id
        ...
        @db_query("ALTER TABLE `cours` ADD FULLTEXT `cours` (`code`, `description`, `intitule`, `course_keywords`)");
