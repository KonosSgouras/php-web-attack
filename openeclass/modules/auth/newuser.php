...
if (!isset($submit)) {
    ...
    $prenom_form = htmlspecialchars(strip_tags($prenom_form));
	$nom_form = htmlspecialchars(strip_tags($nom_form));
	$email= htmlspecialchars(strip_tags($email));
	$am = htmlspecialchars(strip_tags($am));
	...
	db_query("INSERT INTO `$mysqlMainDb`.loginout (loginout.idLog, loginout.id_user, loginout.ip, loginout.when, loginout.action)
