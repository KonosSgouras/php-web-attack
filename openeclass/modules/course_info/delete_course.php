...
if($is_adminOfCourse) {
	if(isset($delete)) {
		...
		db_query("DELETE FROM `$mysqlMainDb`.cours WHERE code='$currentCourseID'");
		db_query("DELETE FROM `$mysqlMainDb`.cours_user WHERE cours_id='$cours_id'");
		db_query("DELETE FROM `$mysqlMainDb`.cours_faculte WHERE code='$currentCourseID'");
		db_query("DELETE FROM `$mysqlMainDb`.annonces WHERE cours_id='$cours_id'");
