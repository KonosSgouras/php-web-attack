...
function getUserLessonInfo($uid, $type)
{
	...
	$db_query_result = db_query($user_courses, $mysqlMainDb);
	$repeat_val = 0;
	//getting user's lesson info
	while ($mycourses = mysqli_fetch_array($db_query_result)) {
	...
	while ($my_memory_result = mysqli_fetch_row($memory_result)) {
