...
list($tutor_id, $group_name) = mysqli_fetch_row(db_query("SELECT tutor, name FROM student_group WHERE id='$userGroupId'", $currentCourseID));
...
if ($type == 'duration') {
        ...
        list($min_date) = mysqli_fetch_row(db_query(
