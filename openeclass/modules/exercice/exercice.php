...
list($num_of_ex) = mysqli_fetch_array($qnum);
...
while($row = mysqli_fetch_array($result)) {
	...
	// prof only
		...
		$eid = $row['id'];
		$NumOfResults = mysqli_fetch_array(db_query("SELECT COUNT(*) FROM exercise_user_record 
...
cData;
	...
	$CurrentAttempt = mysqli_fetch_array(db_query("SELECT COUNT(*) FROM exercise_user_record
