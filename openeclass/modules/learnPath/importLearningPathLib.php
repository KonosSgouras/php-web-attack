...
function doImport($currentCourseID, $mysqlMainDb, $webDir, $scoFileSize, $scoFileName, $displayExtraMessages = false) {
    ...
    $tempPathId = mysqli_insert_id($db);
        ...
        else
        {
            ...
            foreach ( $manifestData['items'] as $item )
            {
                ...
                if( (!isset($item['identifierref']) || $item['identifierref'] == '') && isset($item['title']) && $item['title'] !='')
                {
                    ...
                    $insertedModule_id[$i] = mysqli_insert_id($db);  // array of all inserted module ids
                    ...
                    $insertedLPMid[$item['itemIdentifier']]['LPMid'] = mysqli_insert_id($db);
                ...
                $insertedAsset_id[$i] = mysqli_insert_id($db); // array of all inserted asset ids
