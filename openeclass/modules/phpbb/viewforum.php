...
$topic_count = mysqli_fetch_row(db_query("SELECT COUNT(*) FROM topics WHERE forum_id = '$forum'"));
...
if (mysqli_num_rows($result) > 0) { // topics found
	while($myrow = mysqli_fetch_array($result)) {
		...
		list($topic_action_notify) = mysqli_fetch_row(db_query("SELECT notify_sent FROM forum_notify 
