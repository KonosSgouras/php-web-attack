...
if (isset($submit))  {
	$dq = $dq * 1000000;
        ...
        $drq = $drq * 1000000;
  // Update query
	$sql = db_query("UPDATE cours SET doc_quota='$dq',video_quota='$vq',group_quota='$gq',dropbox_quota='$drq' 			WHERE code='".mysqli_real_escape_string($db,$_GET['c'])."'");
...
// Display edit form for course quota
	...
	$q = mysqli_fetch_array(db_query("SELECT code,intitule,doc_quota,video_quota,group_quota,dropbox_quota
			FROM cours WHERE code='".mysqli_real_escape_string($db,$_GET['c'])."'"));
