...
// select course database
    mysqli_select_db($db,$repertoire);
...
############################# DOCUMENTS ###########################################
db_query ("CREATE TABLE document (id int(4) NOT NULL auto_increment,
...
############################## LINKS #############################################
    ...
    db_query("INSERT INTO liens VALUES (
               '1',
               'http://www.google.com',
               'Google',
               '$langGoogle','0','0'
...
db_query("CREATE TABLE student_group (
    id int(11) NOT NULL auto_increment,
...
db_query("CREATE TABLE user_group (
    id int(11) NOT NULL auto_increment,
...
db_query("CREATE TABLE group_properties (
    id tinyint(4) NOT NULL auto_increment,
...
db_query("INSERT INTO group_properties
