...
$a=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM cours"));
$a1=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM cours WHERE visible='2'"));
$a2=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM cours WHERE visible='1'"));
$a3=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM cours WHERE visible='0'"));
...
$e=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM user"));
$b=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM user where statut='1'"));
$c=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM user where statut='5'"));
$d=mysqli_fetch_array(db_query("SELECT COUNT(*) FROM user where statut='10'"));
